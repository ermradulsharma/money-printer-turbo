...
class _SynchronizedConfig(dict):
    """Synchronized configuration dictionary guarded by a process lock."""
...
project_description = _cfg.get(
    "project_description",
    "<a href='https://github.com/ermradulsharma/money-printer-turbo'>https://github.com/ermradulsharma/money-printer-turbo</a>",
)
