...
def _safe_json_parse(text: str):
    """Safely parse JSON text from LLM outputs, repairing common syntax flaws
    like code fences, trailing commas, and single quotes.
    """
    ...
    # Fix trailing commas: e.g. [ "term1", "term2", ] -> [ "term1", "term2" ]
    ...
    # Extract first array or object using regex
    ...
    if match:
        ...
        try:
            ...
            extracted_repaired = re.sub(r",\s*([\]}])", r"\1", extracted)
            try:
    ...
    for i in range(_max_retries):
        try:
            ...
            if response.startswith("Error: "):
                ...
                return []
            search_terms = _safe_json_parse(response)
