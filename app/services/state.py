...
class BaseState(ABC):
    ...
    def patch_task(self, task_id: str, **kwargs) -> bool:
        """Update specific fields of an existing task; returns False if task does not exist."""
        pass
...
class RedisState(BaseState):
    ...
    def _convert_to_original_type(value):
        ...
        Uses json.loads first for strict, secure deserialization, with fallback
        to ast.literal_eval for legacy string representations.
        """
