...
metadata:
  ...
  version: "1.3.2"
  upstream: "https://github.com/ermradulsharma/money-printer-turbo"
---
...
```text
https://raw.githubusercontent.com/ermradulsharma/money-printer-turbo/main/docs/skill/mpt_agent.py
```
